...
for (let i = 0; i < articulo.length; i++) {
    articulo[i].addEventListener("click", cambiarArticulo);
...
texto2[i].addEventListener("mouseover", mouseover)
function mouseover() {
...
imagenes2[i].addEventListener("mouseover", mouseOver);
imagenes2[i].addEventListener("mouseout", mouseOut);
 
function mouseOver(){
imagenes2[i].setAttribute('src', 'assets/abracadabra.gif')};  
}
function mouseOut(){
imagenes2[i].setAttribute('src', 'assets/magic-1.gif')};  
}
